CSS_LINUX_FONT = """ 
/* ================= Глобальный шрифт для всех виджетов ================= */
* {
...
/* ================= Принудительный цвет текста (для Linux с тёмной темой) ================= */
/* QTreeView и QTableWidget: основной текст */
QTreeView, QTableWidget {
	color: #000000;
}

/* Ячейки (на случай, если color не наследуется) */
...
/* Сохраняем белый цвет текста для выделенных ячеек (чтобы не потерять контраст) */
...
def get_css(is_linux: bool):
	""" Возвращает настройки css-стилей в зависимости от платформы """
	global CSS_LINUX_FONT, CSS_SETTING
	if is_linux:
		return CSS_LINUX_FONT+CSS_SETTING
	else:
		return CSS_SETTING
