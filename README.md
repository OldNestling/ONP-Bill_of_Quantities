...
Подробная информация по использованию программы приведена в [руководстве пользователя](https://github.com/OldNestling/ONP-Bill_of_Quantities.git/releases/latest/download/ONP_Система_ВОР.%20Руководство.pdf).
...
[Скачать исполняемый файл.](https://github.com/OldNestling/ONP-Bill_of_Quantities.git/releases/latest/download/ONP_Система_ВОР.exe)
